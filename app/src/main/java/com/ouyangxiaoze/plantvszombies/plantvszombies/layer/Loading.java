...
import com.ouyangxiaoze.plantvszombies.plantvszombies.util.CommonUtil;
	 ...
	 *
	 */
	public class Loading extends BaseLayer {
		...
		private List<CCSpriteFrame> loadFreams=new ArrayList<CCSpriteFrame>();
		private void init() {
			loadBGM();
			loadImage();
			timeConsuming();
		...
		// frames.add(CCSprite.sprite("image/loading/loading01.png").displayedFrame());
		// // frames.add(CCSprite.sprite("image/loading/loading02.png").displayedFrame());
		// loadingAnimation = CCAnimation.animation(null, frames);
		//
		// loadingAnimate = CCAnimate.action(loadingAnimation);
		// }
		...
		private void loadImage() {
			...
			start = CCSprite.sprite("image/loading/loading02.png");
			start.setScale(0.6);
